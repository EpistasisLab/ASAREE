...
// A node inspector is a large, FIXED-size floating frame -- deliberately not a
// box that grows/shrinks to fit whichever of its Parameters/Settings tabs is
// active. The frame never resizes on tab switch; only the panels inside it
// scroll independently. Sized in viewport units since this Popup is
// `position: fixed` (see dialog.tsx): a constant ~2rem margin on every side,
// applied identically regardless of node type or which tab/field count is
// showing.
//
 ...
 * scrolls as a whole. This is the layout half of the fixed-frame contract
