...
def upgrade() -> None:
    op.add_column('registered_datasets', sa.Column('raw_path', sa.Text(), nullable=True))
    op.add_column('registered_datasets', sa.Column('raw_sha256', sa.String(length=64), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_column('registered_datasets', 'raw_sha256')
    op.drop_column('registered_datasets', 'raw_path')
